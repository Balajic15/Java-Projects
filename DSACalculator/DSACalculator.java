...
public class DSACalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nThank you for using the DSA Calculator. Goodbye!");
    }

    public static void run(Scanner scanner) {
        System.out.println("\n--- Starting DSA Console Calculator ---");
        System.out.println("Welcome to the DSA Calculator!");
        ...
        while (true) {
            ...
            while (tokens == null) {
                try {
                    System.out.print("\nEnter a expression (or type 'exit' to quit): ");
                    expr = scanner.nextLine();
                    if (expr.equalsIgnoreCase("exit") || expr.equalsIgnoreCase("quit")) {
                        System.out.println("\n--- DSA Calculator Exited ---");
                        return;
                    }
                    ...
                    System.out.println("Input: " + expr);
                    System.out.println("Expression cannot be computed. Please try again.");
                }
            }
